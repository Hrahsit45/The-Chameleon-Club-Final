...
<div className="Sn-thr-fd text-black">
<div className="comp-feed text-black">
<div className={`component ${selectedComponent === 'all' ? 'selected' : ''}`} onClick={() => handleComponentClick('all')}>
All
</div>
<div className={`component ${selectedComponent === 'Following' ? 'selected' : ''}`} onClick={() => handleComponentClick('Following')}>
Following
</div>
...
{selectedComponent === '' && <p><Feed id = {props.id}/></p>}
